...
![daily-update](https://github.com/daiduong-eth/vietnam-lottery-xsmb/actions/workflows/daily-update.yml/badge.svg) ![draws](https://img.shields.io/static/v1?label=draws&message=7%2C796&color=blue) ![range](https://img.shields.io/static/v1?label=range&message=2005-01-01+%E2%86%92+2026-08-14&color=green) ![views](https://hits.sh/github.com/daiduong-eth/vietnam-lottery-xsmb.svg?label=views&color=orange) ![license](https://img.shields.io/static/v1?label=license&message=MIT&color=yellow)

**Kết quả mới nhất:** Thứ 6, 14/08/2026 — Đặc biệt **`80018`** (2 số cuối: `18`)

## 🎯 Kết quả mới nhất — 14/08/2026
...
| Toàn lịch sử | 7,796 | `36`(105) `70`(101) `39`(97) `65`(97) `24`(93) | `28`(57) `40`(58) `20`(62) `31`(62) `72`(63) |
...
| 2026 | 222 | 91/100 | `54` (7 lần) |

---

_Updated **2026-08-14 19:09 +07** — auto by [GitHub Action](.github/workflows/daily-update.yml)._  
_Dataset: [`data/xsmb.csv`](data/xsmb.csv) · 7,796 kỳ · 2005-01-01 → 2026-08-14._  
